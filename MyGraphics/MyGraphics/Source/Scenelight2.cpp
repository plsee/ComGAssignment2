...
void Scenelight2::Init()
{
    ...
    meshList[GEO_SPHERE] = MeshBuilder::GenerateCube("Sphere", (0, 0, 0));
    ...
    meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("FLOOR", Color(0, 0, 0));
    meshList[GEO_QUAD]->material.kAmbient.Set(0.5, 0.5, 0.5);
    meshList[GEO_QUAD]->material.kDiffuse.Set(0.2, 0.2, 0.2);
    meshList[GEO_QUAD]->material.kSpecular.Set(1, 1, 1);
    meshList[GEO_QUAD]->material.kShininess = 0;

    meshList[GEO_CUBE] = MeshBuilder::GenerateCube("TestCube", Color(0, 0, 0));
